...
donnees_modeles = donnees_modeles[-grep("ada|kppv", donnees_modeles)] # on ne prend pas ada et kppv (trop lents)
...
load("./../output/none_lgb_info.RData")                          # info lgb none
load("./../output/up_lgb_info.RData")                            # info lgb up
load("./../output/glm_stacking_model_info.RData")                # info stacking
load("./../output/combinaison_model_info.RData")                 # info combi
